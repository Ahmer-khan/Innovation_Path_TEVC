...
class RankAndAssociation(Survival):
    ...
    def __init__(self, cnst, curr, alpha, curr_f,zeta, nds=None):
    ...
    def _do(self,
        ...
        fronts,cd_path,counts = self.nds.do(X,F,anchorf,count_list,self.cnst,self.x0, self.xf, CV, n_stop_if_ranked=n_survive)
        curr_anch = 0
